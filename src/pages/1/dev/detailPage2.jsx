...
const DetailPage = ({ detailId, handleBackClick }) => {
    ...
    const fetchArmada = async () => {
        try {
            const response = await axios.get(`https://apipm.delapandelapanlogistics.com/api/v1/armada/${detailId}`, {
                headers: { Authorization: token },
            });
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put(`https://apipm.delapandelapanlogistics.com/api/v1/armada/${detailId}`, dataArmadaToSubmit, {
                headers: {
                    Authorization: token,
