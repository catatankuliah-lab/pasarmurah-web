            ...
            <div className="col-md-12 mt-3">
                <div className="row">
                    ...
                    <div className="col-md-3 col-sm-12 mb-3">
                        ...
                        <button type="button" onClick={handleUpdate} className="btn btn-primary w-100">SIMPAN PERUBAHAN</button>
                    </div>
                    <div className="col-lg-12 mt-2">
                        <div className="mb-3">
                            <div className="divider text-start">
                    ...
                    <div className="col-md-3 col-sm-12 mb-3">
                        ...
                        <input className="form-control" type="number" id="kpm_jumlah" name='kpm_jumlah' placeholder="Jumlah KPM" value={dtt} required readOnly />
                    </div>
                    <div className="col-md-3 col-sm-12 mb-3">
                        <label htmlFor="tonase" className="form-label">Input Tonase Kg</label>
                        <input className="form-control" type="number" id="tonase" name='tonase' placeholder="0 Kg" onChange={handleChangeTonase} required />
                    </div>
                    <div className="col-md-3 col-sm-12 mb-3">
                        <label htmlFor="" className="form-label">Proses</label>
                                                ...
                                                <tr key={idx}>
                                                    ...
                                                    <td style={{ textAlign: 'center' }}>
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                handleDelete(item.id_item_lo, item.id_lo)
                                                            }
                                                        >
